...
def Test_float_funcs_args()
  ...
  # log2()
  v9.CheckSourceDefAndScriptFailure(['log2("a")'], ['E1013: Argument 1: type mismatch, expected number but got string', 'E1219: Float or Number required for argument 1'])
  assert_equal('0.0', string(log2(1.0)))
  # pow()
