...
def Test_float_funcs_args()
  ...
  # hypot()
  v9.CheckSourceDefAndScriptFailure(['hypot("a", 1.1)'], ['E1013: Argument 1: type mismatch, expected number but got string', 'E1219: Float or Number required for argument 1'])
  assert_equal('-2.356194', string(hypot(-1, -1)))
  v9.CheckSourceDefAndScriptFailure(['hypot(1.2, "a")'], ['E1013: Argument 2: type mismatch, expected number but got string', 'E1219: Float or Number required for argument 2'])
  v9.CheckSourceDefAndScriptFailure(['hypot(1.2)'], ['E119:', 'E119:'])
  # isinf()
